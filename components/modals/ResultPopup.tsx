      ...
      >
        ...
        <div className="px-6 py-6 flex flex-col items-center text-center">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close"
            className="absolute right-3 top-3 rounded-lg p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors"
          >
            <X className="h-4 w-4" />
          </button>
          ...
          {/* Icon */}
          <div
            className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-full mb-3
          ...
          <div className="mt-5">
            <button
              type="button"
              onClick={onClose}
              className={`min-h-[38px] rounded-lg px-6 py-2 text-sm font-semibold transition-colors
                ${isSuccess
