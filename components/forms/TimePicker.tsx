    ...
    <div className={`w-full ${className}`} ref={timePickerRef}>
      ...
      <div className="relative">
        ...
        {isOpen && popupStyle && typeof document !== 'undefined' && createPortal(
              <div id={`time-picker-portal-${portalId}`} style={{ position: 'fixed', ...(popupStyle.top != null ? { top: popupStyle.top } : { bottom: popupStyle.bottom }), left: popupStyle.left, zIndex: 99999 }} className="mt-1 w-[110px] bg-white/80 backdrop-blur-xl border border-gray-200 rounded-lg">
