  ...
  const cards = [
    {
      ...
      description:
        "Start a new scene-of-crime visit record and assign officers.",
      icon: (
        <Clipboard
          className="w-12 h-12"
          weight="fill"
    ...
    },
    {
      ...
      description:
        "Add one or more crime scenes under a started visit and save with CVR.",
      icon: (
        <MapPin
          className="w-12 h-12"
          weight="fill"
    ...
    },
    {
      ...
      description:
        "View all crime scenes that have been saved under CVR numbers.",
      icon: (
        <FileText
          className="w-12 h-12"
          weight="fill"
          ...
          <div className="w-full px-4 sm:px-6 lg:px-8 py-8 flex-1">
            <section className="mb-12">
              ...
              <p className="text-sm text-gray-500 mb-6">
                Manage scene-of-crime visits, officer assignments, and evidence
                examination records.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                {cards.map((card) => (
                  <FeatureCard
                    ...
                    subtitle={
                      <span className="font-noto-sinhala">{card.subtitle}</span>
                    }
