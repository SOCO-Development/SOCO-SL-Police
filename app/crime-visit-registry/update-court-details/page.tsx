...
export default function UpdateCourtDetailsPage() {
  ...
  const href =
    selected && sceneMayEditAmended(selected)
      ? `/crime-visit-registry/edit-crime-scene?id=${encodeURIComponent(id)}&focus=court`
      : '';
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-0.5">
                  Only CVRs with approved edit access are listed. The form opens scrolled to court details.
                </p>
              </div>
            </div>
