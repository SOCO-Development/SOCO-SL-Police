...
export default function UpdateCourtDetailsPage() {
  ...
  const columns: AppTableColumn<CrimeScene>[] = [
    ...
    },
    {
      ...
      render: (_, row) => (
        <Link
          href={`/crime-visit-registry/edit-crime-scene?id=${encodeURIComponent(row.id)}&focus=court`}
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-0.5">
                    Only CVRs with approved edit access are listed. The form opens at court details.
                  </p>
                </div>
              </div>
            </div>
