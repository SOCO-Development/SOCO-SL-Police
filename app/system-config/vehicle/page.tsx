                    ...
                    <div className="w-full px-4 sm:px-6 lg:px-8 py-8 flex-1">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-0.5 font-noto-sinhala">වාහන වින්‍යාස කිරීම</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-12 flex flex-col items-center justify-center text-center max-w-lg mx-auto">
                            <div className="p-5 rounded-2xl bg-gradient-to-br from-amber-50 to-yellow-50 mb-5">
                                <Truck className="w-12 h-12" weight="fill" style={{ color: '#f59e0b' }} />
                            </div>
                            <h3 className="text-lg font-semibold text-gray-800 mb-2">Vehicle Configuration</h3>
                            <p className="text-sm text-gray-500 leading-relaxed">
                                This section will allow you to configure and manage vehicles assigned to SOCO operations.
                            </p>
